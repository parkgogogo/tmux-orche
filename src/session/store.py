...
from .types import SessionMeta, as_session_meta
...
def save_meta(session: str, meta: SessionMeta) -> None:
    ensure_directories()
...
def load_meta(session: str) -> SessionMeta:
    ...
    try:
        ...
        return {}
    return as_session_meta(data)


def _iter_meta_payloads() -> Iterable[SessionMeta]:
    ensure_directories()
