...
def test_run_session_watchdog_emits_failed_event_when_codex_capture_shows_stream_disconnect(
    ...
    backend.save_meta(
        "demo-session",
        {
            ...
            "pending_turn": {
                ...
                "prompt": "Implement the parser refactor.",
                "before_capture": "",
                "submitted_at": 0.0,
                "pane_id": "%1",
                "notifications": {},
    ...
    samples = iter(
        [
            ...
            },
            {
                ...
                "pane_current_command": "codex",
                "capture_bytes": 125,
                "tail": "stream disconnected before completion:",
            },
        ]
    )
    emitted = []
